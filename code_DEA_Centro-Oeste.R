...
# Produto: Rodando o DEA Centro-Oeste
################################################################################
...
dados_full_mapa %>%
  ...
  labs(fill     = "Eficiência",
       title    = "DEA: Eficiência dos Municípios do Centro-Oeste  - 2019") +
  theme_void()
...
dados_full_mapa %>%
  ...
  scale_fill_viridis_d(option = "mako", na.value = "grey90") +
  labs(fill     = "Eficiência",
       title    = "DEA: Eficiência dos Municípios do Centro-Oeste  - 2021") +
  theme_void()
...
dados_full_mapa %>%
  ...
  scale_fill_viridis_d(option = "mako", na.value = "grey90") +
  labs(fill     = "Eficiência",
       title    = "DEA: Eficiência dos Municípios do Centro-Oeste  - 2023") +
  theme_void()
