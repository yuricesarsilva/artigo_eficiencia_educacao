...
dados_full_mapa %>%
  ...
  labs(fill     = "Eficiência",
       title    = "DEA: Eficiência dos Municípios do Sudeste - 2019") +
  theme_void()
...
dados_full_mapa %>%
  ...
  scale_fill_viridis_d(option = "mako", na.value = "grey90") +
  labs(fill     = "Eficiência",
       title    = "DEA: Eficiência dos Municípios do Sudeste - 2021") +
  theme_void()
...
dados_full_mapa %>%
  ...
  scale_fill_viridis_d(option = "mako", na.value = "grey90") +
  labs(fill     = "Eficiência",
       title    = "DEA: Eficiência dos Municípios do Sudeste - 2023") +
  theme_void()
...
write.xlsx(escores2019, "results/escores_sudeste_2019.xlsx")
write.xlsx(benchmarks2019, "results/benchmarks_sudeste_2019.xlsx")

write.xlsx(escores2021, "results/escores_sudeste_2021.xlsx")
write.xlsx(benchmarks2021, "results/benchmarks_sudeste_2021.xlsx")

write.xlsx(escores2023, "results/escores_sudeste_2023.xlsx")
write.xlsx(benchmarks2023, "results/benchmarks_sudeste_2023.xlsx")
