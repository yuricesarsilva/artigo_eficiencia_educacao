...
dados_full_mapa %>%
  ...
  labs(fill     = "Eficiência",
       title    = "DEA: Eficiência dos Municípios do Sul - 2019") +
  theme_void()
...
write.xlsx(escores2019, "results/escores_sul_2019.xlsx")
write.xlsx(benchmarks2019, "results/benchmarks_sul_2019.xlsx")

write.xlsx(escores2021, "results/escores_sul_2021.xlsx")
write.xlsx(benchmarks2021, "results/benchmarks_sul_2021.xlsx")

write.xlsx(escores2023, "results/escores_sul_2023.xlsx")
write.xlsx(benchmarks2023, "results/benchmarks_sul_2023.xlsx")
